 ...
 * This is necessary because AudioContext.decodeAudioData expects a file format (like WAV), not raw samples.
 * @param data The raw audio data as a Uint8Array (16-bit PCM).
